 ...
 * @author pdsanchez
 */
public class IndividualByte implements Comparable<IndividualByte> {
     ...
     */
    public IndividualByte(byte[] chromosome) {
     ...
     * @param idx
     */
    public void setGene(int idx, byte gene) {
    ...
    @Override
    public int compareTo(IndividualByte o) {
